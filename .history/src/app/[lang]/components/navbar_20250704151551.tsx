    ...
    >
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 px-3 py-2 text-sm border rounded-md shadow-sm hover:ring-1 ring-primary bg-white">
                  <Image
              ...
              <DropdownMenuContent align="end" className="bg-white shadow-lg hover:ring-1 ring-gray-200">
                {languages.map((lang) => (
                  <DropdownMenuItem
                    key={lang.code}
      ...
      >
        ...
        <div className="mt-8">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 px-3 py-2 text-sm border rounded-md shadow-sm w-full hover:ring-1 ring-primary">
                <Image
                  src={languages.find((l) => l.code === currentLang)?.flag || FlagEN}
                  alt={currentLang}
                  width={20}
