...
const supportedLangs = ["en", "lo", "ko"] as const;
type Lang = (typeof supportedLangs)[number];

const loadingTexts = {
   en: "Loading SIRI SERVICE...",
  lo: "ກຳລັງໂຫລດ SIRI SERVICE...",
  ko: "SIRI 서비스 로딩 중...",
};
...
export default function ClientLayout({
  ...
  useEffect(() => {
    ...
    const currentLang: Lang = isValidLang(params.lang as string) ? params.lang as Lang : "en";
    setLang(currentLang);
