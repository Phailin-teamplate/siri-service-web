...
export default function Navbar() {
  ...
  const translatedNavLinks = navLinks.map((link, i) => ({
    ...link,
    label: labels[currentLang]?.[i] || link.id,
  }));
          ...
          {isMounted && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="px-2 py-1 flex items-center gap-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm hover:ring-2 ring-primary transition duration-200 bg-white/80 dark:bg-zinc-800/70"
                >
                  <Image
              ...
              <DropdownMenuContent
                className="w-36 p-1 rounded-md border bg-white dark:bg-zinc-900 shadow-lg"
                align="end"
              >
                {languages.map((lang) => (
                  <DropdownMenuItem
                    ...
                    className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-primary/10 dark:hover:bg-primary/20 cursor-pointer transition"
                  >
                    <Image
                      src={lang.flag}
                      alt={lang.label}
