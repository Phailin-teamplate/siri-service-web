...
<button
  ...
  className="absolute -left-10 top-1/2 -translate-y-1/2 z-10 bg-white border border-gray-300 rounded-full w-9 h-9 shadow-sm hover:bg-gray-100 transition flex items-center justify-center"
  aria-label="Previous"
>
  ‹
</button>
...
<button
  ...
  className="absolute -right-10 top-1/2 -translate-y-1/2 z-10 bg-white border border-gray-300 rounded-full w-9 h-9 shadow-sm hover:bg-gray-100 transition flex items-center justify-center"
  aria-label="Next"
>
  ›
</button>
