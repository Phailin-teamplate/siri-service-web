...
export default function About() {
  return (
    <div className="w-full bg-white px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-32 py-16 sm:py-20 lg:py-24" id="about">
      {/* Section Title */}
      ...
      {/* Content: Image + Text */}
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between py-5 gap-10 md:gap-16">
        {/* Image */}
        ...
        {/* Text */}
        <div className="w-full md:w-1/2 max-w-[700px] text-center md:text-left md:item-start">
