...
export default function About() {
  ...
  {/* Image */}
  <div className="w-full max-w-[660px] rounded-xl overflow-hidden shadow-lg">
    <Image
      src={AboutSV}
      alt="About"
      width={660} // เพิ่มจาก 602
      height={580} // เพิ่มจาก 540
  ...
  <div className="w-full max-w-[720px] text-center md:text-left">
    <p className="text-[22px] md:text-[22px] font-medium leading-relaxed">
