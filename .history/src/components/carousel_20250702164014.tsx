...
export default function PortfolioCarousel() {
  ...
  <button
    ...
    className="absolute -left-12 top-1/2 -translate-y-1/2 z-20 bg-white border border-gray-300 hover:border-yellow-500 text-gray-600 hover:text-yellow-600 rounded-full w-10 h-10 shadow-lg flex items-center justify-center transition-all duration-200 cursor-pointer"
  >
  ...
  <button
    ...
    className="absolute -right-12 top-1/2 -translate-y-1/2 z-20 bg-white border border-gray-300 hover:border-yellow-500 text-gray-600 hover:text-yellow-600 rounded-full w-10 h-10 shadow-lg flex items-center justify-center transition-all duration-200 cursor-pointer"
  >
