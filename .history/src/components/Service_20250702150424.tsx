...
<div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-10">
  {/* Text */}
  <div className="w-full md:w-1/2 max-w-[680px] text-center md:text-left">
    <h1 className="text-black text-3xl font-semibold mb-6">
      Event Planning & Management
    </h1>
    <p className="text-gray-700 text-2xl font-normal leading-relaxed">
...
<div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-10 mt-20">
  {/* Image */}
  <div className="w-full md:w-1/2 max-w-[500px]">
    <Image
      src={Service2}
