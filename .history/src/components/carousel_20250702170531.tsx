...
export default function PortfolioCarousel() {
  ...
  return (
    ...
    >
      ...
      {/* Carousel */}
      <div className="relative w-full px-10 md:px-0 lg:px-0 xl:px-0">
        <Carousel>
          <CarouselContent>
            {items.map((item, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row items-center justify-between gap-2 md:gap-14">
                  {/* Image */}
                  <div className="w-full md:w-1/2">
                    <div className="w-full max-w-[650px] h-[220px] sm:h-[250px] md:h-[320px] lg:h-[380px] xl:h-[400px] mx-auto">
                      <Image
                        src={item.image}
                        alt={item.title}
                        width={550}
...
<button
  ...
  className="absolute left-0 md:left-[-48px] top-1/2 -translate-y-1/2 z-10 
             bg-white border border-gray-300 hover:border-yellow-500 
             text-gray-600 hover:text-yellow-600 
             rounded-full md:w-10 md:h-10 w-5 h-5 shadow-md 
...
<button
  ...
  className="absolute right-0 md:right-[-48px] top-1/2 -translate-y-1/2 z-10 
             bg-white border border-gray-300 hover:border-yellow-500 
             text-gray-600 hover:text-yellow-600 
             rounded-full md:w-10 md:h-10 w-8 h-8 shadow-md 
             flex items-center justify-center 
             transition-all duration-200"
>
