...
export default function ClientLayout({
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen flex flex-col items-center justify-center bg-white text-yellow-500"
    >
      <div className="relative w-32 h-32 flex items-center justify-center">
        ...
        {/* วงกลมหมุน สีเหลือง */}
        <motion.div
          className="absolute w-full h-full border-4 border-dashed border-yellow-500 rounded-full"
          animate={{ rotate: 360 }}
      ...
      <motion.p
        ...
        className="text-lg font-medium mt-5 text-yellow-500"
      >
