...
export default function Service() {
  return (
    <div className="w-full bg-white px-6 md:px-12 py-20" id="service">
     ...
     <p className="text-gray-700 text-[20px] md:text-[22px] font-medium leading-relaxed">
    We provide end-to-end planning and on-site management for<br />
    government, corporate, and institutional events<br />
    including forums, exhibitions, and conferences.<br />
    We handle logistics, operations, and vendor coordination<br />
