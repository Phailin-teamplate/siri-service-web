...
export default function Footer() {
  return (
    <div className="w-full bottom-0 bg-[#535353] text-white">
      <div className="flex items-center justify-between px-20 py-3">
        <div className=" mx-auto flex flex-col md:flex-row justify-between items-start md:items-start gap-8 md:gap-12">
          {/* Left Section */}
