...
<button
  ...
  className="absolute left-4 md:left-6 top-1/2 -translate-y-1/2 z-20 bg-white border border-gray-300 hover:border-yellow-500 text-gray-600 hover:text-yellow-600 rounded-full w-10 h-10 shadow-md flex items-center justify-center transition-all duration-200"
