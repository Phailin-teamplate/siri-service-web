...
export default function About() {
  return (
    <section
      id="about"
      className="w-full bg-white px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-32 py-16 sm:py-20 lg:py-24 scroll-mt-28"
     
    >
      {/* Section Title */}
           <motion.div className="text-center mb-10"  initial={{ opacity: 0, y: 40 }}
